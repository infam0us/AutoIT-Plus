...
char * AutoIt_Script::m_szKeywords[K_MAX] =	{
	"VE", "YADA", "DEGIL",
	"EGER", "ISE", "DEGILSE", "VEYA", "ESON",
	"WHILE", "WEND",
	"DO", "UNTIL",
	"FOR", "NEXT", "TO", "STEP",
	"DONGUDUR", "DONGUDEVAM",
	"SEC", "DURUM", "SSON",
	"DIM", "REDIM", "YEREL", "GENEL", "SABIT",
	"FONKSIYON", "FSON", "DONUS",
	"CIK",
	"BYREF"
};
...
AutoIt_Script::AutoIt_Script()
{
	...
	m_sOnExitFunc				= "ProgramCikisinda";
...
{
{"ARCCOS", &AutoIt_Script::F_ACos, 1, 1},
 {"ARCSIN", &AutoIt_Script::F_ASin, 1, 1},
 {"ARCTAN", &AutoIt_Script::F_ATan, 1, 1},
 {"ASCII", &AutoIt_Script::F_Asc, 1, 1},
 {"BASLAT", &AutoIt_Script::F_Run, 1, 3},
 {"BEKLE", &AutoIt_Script::F_Sleep, 1, 1},
 {"BIRAK", &AutoIt_Script::F_Break, 1, 1},
 {"CAGIR", &AutoIt_Script::F_Call, 1, 1},
 {"CDKAPAK", &AutoIt_Script::F_CDTray, 2, 2},
 ...
 {"DIZINBOYUTOKU", &AutoIt_Script::F_DirGetSize, 1, 2},
 {"DIZINKOPYALA", &AutoIt_Script::F_DirCopy, 2, 3},
 {"DIZINOLUSTUR", &AutoIt_Script::F_DirCreate, 1, 1},
 {"DIZINSIL", &AutoIt_Script::F_DirRemove, 1, 2},
 {"DIZINTASI", &AutoIt_Script::F_DirMove, 2, 3},
 ...
 {"GIRISENGELLE", &AutoIt_Script::F_BlockInput, 1, 1},
 {"GIRISKUTUSU", &AutoIt_Script::F_InputBox, 2, 9},
 ...
 {"KONSOLYAZ", &AutoIt_Script::F_ConsoleWrite, 1, 1},
 {"KONTROLAKTIF", &AutoIt_Script::F_ControlEnable, 3, 3},
 {"KONTROLDEAKTIF", &AutoIt_Script::F_ControlDisable, 3, 3},
 {"KONTROLKOMUT", &AutoIt_Script::F_ControlCommand, 4, 5},
 {"KONTROLODAKLA", &AutoIt_Script::F_ControlFocus, 3, 3},
 {"KONTROLODAKOKU", &AutoIt_Script::F_ControlGetFocus, 1, 2},
 {"KONTROLTIKLA", &AutoIt_Script::F_ControlClick, 3, 5},
 {"LOG", &AutoIt_Script::F_Log, 1, 1},
 {"MAKROKAYDET", &AutoIt_Script::F_AdlibEnable, 1, 2},
 {"MAKROSIL", &AutoIt_Script::F_AdlibDisable, 0, 0},
 {"MEGIAYARLA", &AutoIt_Script::F_AutoItSetOption, 2, 2},
 ...
 {"MSJKUTUSU", &AutoIt_Script::F_MsgBox, 3, 4},
 {"MUTLAK", &AutoIt_Script::F_Abs, 1, 1},
 {"NUMBER", &AutoIt_Script::F_Number, 1, 1},
 {"OPT", &AutoIt_Script::F_AutoItSetOption, 2, 2},
 {"PANOOKU", &AutoIt_Script::F_ClipGet, 0, 0},
 {"PANOYAZ", &AutoIt_Script::F_ClipPut, 1, 1},
 ...
 {"RASTGELE", &AutoIt_Script::F_Random, 0, 3},
 ...
 {"TANIMLA", &AutoIt_Script::F_Assign, 2, 3},
 ...
 {"TUSGONDER", &AutoIt_Script::F_Send, 1, 2},
 ...
 {"WINAKTIFBEKLE", &AutoIt_Script::F_WinWaitActive, 1, 3},
 {"WINALBASLIK", &AutoIt_Script::F_WinGetTitle, 1, 2},
 ...
 {"WINKAPAT", &AutoIt_Script::F_WinClose, 1, 2},
 {"WINKAPATBEKLE", &AutoIt_Script::F_WinWaitClose, 1, 3},
...
void AutoIt_Script::FatalError(int iErr, int nCol)
{
	...
	if (szInclude == NULL)
		sprintf(szOutput, "Satir %d:\n\n", nAutScriptLine);
	else
		sprintf(szOutput, "Satir %d  (Dosya \"%s\"):\n\n", nAutScriptLine, szInclude);
...
AUT_RESULT AutoIt_Script::Execute(int nScriptLine)
{
	...
	if (m_nExecuteRecursionLevel == 1)
	{
		...
		if (Parser_FindUserFunction("ProgramBaslarken", nTemp1, nTemp2, nTemp3, nTemp4) == true)
